    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="container mx-auto px-4 py-8 flex-grow">
        ...
        <div className="bg-green-50 p-6 rounded-lg mb-12">
          <h2 className="text-2xl font-bold mb-6 text-center text-green-600">Tầm nhìn & Sứ mệnh</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-4 text-green-600">Tầm nhìn</h3>
              <p className="text-gray-700">
                Trở thành cửa hàng cá cảnh hàng đầu Việt Nam, mang đến cho khách hàng những sản phẩm cá cảnh đẹp nhất,
                chất lượng nhất với giá cả hợp lý. Chúng tôi không ngừng nỗ lực để phát triển và mở rộng, đồng thời góp
                phần nâng cao văn hóa chơi cá cảnh tại Việt Nam.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-4 text-green-600">Sứ mệnh</h3>
              <p className="text-gray-700">
                ...
                xây dựng cộng đồng yêu thích cá cảnh tại Việt Nam.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-bold mb-6 text-center text-green-600">Giá trị cốt lõi</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-green-600 text-2xl font-bold">1</span>
              </div>
              <h3 className="text-lg font-bold mb-2 text-green-600">Chất lượng</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-lg font-bold mb-2 text-green-600">Uy tín</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-lg font-bold mb-2 text-green-600">Chuyên nghiệp</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-lg font-bold mb-2 text-green-600">Đổi mới</h3>
              <p className="text-gray-700">
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-bold mb-6 text-center text-green-600">Dịch vụ của chúng tôi</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-lg font-bold mb-4 text-green-600">Cung cấp cá cảnh</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-lg font-bold mb-4 text-green-600">Thiết kế và thi công</h3>
              <ul className="list-disc list-inside text-gray-700 space-y-2">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-lg font-bold mb-4 text-green-600">Phụ kiện và thức ăn</h3>
              <ul className="list-disc list-inside text-gray-700 space-y-2">
        ...
        <div className="bg-green-600 text-white p-8 rounded-lg">
          ...
          <div className="text-center mt-6">
            <Link
              href="/lien-he"
              className="inline-block bg-white text-green-600 px-6 py-2 rounded-md font-medium hover:bg-gray-100 transition-colors"
            >
              Đến trang liên hệ
            </Link>
          </div>
